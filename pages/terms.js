...
// import tw from "tailwind.macro@next";
...
export default ({ headingText = "Terms And Condition" }) => {
  return (
    <>
      {/* <Text> */}
      <p class="mt-2 leading-loose">Last updated: April 21, 2020</p>
      ...
      <h1 class="text-3xl font-bold mt-10">Interpretation and Definitions</h1>
      <h2 class="text-2xl font-bold mt-8">Interpretation</h2>
      <p class="mt-2 leading-loose">
      ...
      <h2 class="text-2xl font-bold mt-8">Definitions</h2>
      <p class="mt-2 leading-loose">
      ...
      <ul class="list-disc list-inside">
        ...
        <li class="ml-2 pb-3">
          ...
          "Us" or "Our" in this Agreement) refers to Treact Inc., Navi Mumbai.
        </li>
        <li class="ml-2 pb-3">
      ...
      <h1 class="text-3xl font-bold mt-10">Acknowledgement</h1>
      <p class="mt-2 leading-loose">
      ...
      <h1 class="text-3xl font-bold mt-10">Links to Other Websites</h1>
      <p class="mt-2 leading-loose">
      ...
      <h1 class="text-3xl font-bold mt-10">Termination</h1>
      <p class="mt-2 leading-loose">
      ...
      <h1 class="text-3xl font-bold mt-10">Limitation of Liability</h1>
      <p class="mt-2 leading-loose">
      ...
      <h1 class="text-3xl font-bold mt-10">Governing Law</h1>
      <p class="mt-2 leading-loose">
      ...
      <h1 class="text-3xl font-bold mt-10">Disputes Resolution</h1>
      <p class="mt-2 leading-loose">
      ...
      <h1 class="text-3xl font-bold mt-10">For European Union (EU) Users</h1>
      <p class="mt-2 leading-loose">
      ...
      <h1 class="text-3xl font-bold mt-10">United States Legal Compliance</h1>
      <p class="mt-2 leading-loose">
      ...
      <h1 class="text-3xl font-bold mt-10">Severability and Waiver</h1>
      <h2 class="text-2xl font-bold mt-8">Severability</h2>
      <p class="mt-2 leading-loose">
      ...
      <h2 class="text-2xl font-bold mt-8">Waiver</h2>
      <p class="mt-2 leading-loose">
      ...
      <h1 class="text-3xl font-bold mt-10">Translation Interpretation</h1>
      <p class="mt-2 leading-loose">
      ...
      <h1 class="text-3xl font-bold mt-10">Contact Us</h1>
      <p class="mt-2 leading-loose">
      ...
      <ul class="list-disc list-inside">
        <li class="ml-2 pb-3">By email: support@example.com</li>
        <li class="ml-2 pb-3">By phone number: 408.996.1010</li>
      </ul>
      {/* </Text> */}
