...
export default function Summary() {
  const me = useUser();
  const { loading, error, data } = useQuery(ORDER_ITEMS_QUERY);

  if (loading) return <p>loading...</p>;
  if (error) return <Error error={error} />;

  const allOrders = me && data.orders;
  const orderItems = allOrders.map((order) => order.items);
  // var merged = [].concat.apply([], orderItems);
  // console.log("DFASDFA", orderItems);

  return (
    <div class="">
      <div class="flex items-center  mt-5 justify-between">
        <h1 class="text-gray-800 text-5xl  mr-6 tracking-normal font-medium">
          Overview
        </h1>
        {/* <div class="text-blue-500">Help</div> */}
      </div>
      {/* fucm */}

      <div class="flex items-center justify-center pt-16 pb-10 gap-12">
        <div class="bg-white text-gray-800 rounded-lg shadow-sm p-16  w-1/2 h-full">
          <div class="flex flex-wrap  items-center">
            <div class="w-full sm:w-1/2 md:w-3/4 text-left">
              <div class=" ">
                <h3 class="text-4xl ">
                  Welcome back,{" "}
                  <span class="capitalize font-medium">{me.name}</span>!
                </h3>
                <div class="pt-6 pb-8">
                ...
                <div class="pt-6 pb-1 ">
                  <span class="capitalize font-medium">3 crops</span>
                </div>
              </div>
            </div>
            <div class="w-full sm:w-1/2 md:w-1/4  ml-auto   text-center">
              <div class=""></div>
            </div>
          </div>
          <div class="h-48 "></div>
        ...
        <div class="flex flex-col w-1/2">
          <div class="  text-gray-800 rounded-lg shadow-sm   h-56">
            <div
              class="bg-cover bg-center w-full h-full  rounded-lg relative"
              style={{
                backgroundImage: `url(https://images.pexels.com/photos/4033003/pexels-photo-4033003.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940)`,
              }}
            ></div>
          </div>
          <div class=" text-gray-800 rounded-lg w-full   mt-10  h-56 mx-auto">
            <div class="flex gap-12">
              <div class="w-full bg-white h-56 rounded-lg flex justify-center text-center flex-col items- shadow-sm">
                <Link href={{ pathname: "/compose" }}>
                  <button class="pb-6">
                    <svg
                      class="w-full h-full px-24  -mt-1 "
              ...
              <div class="w-full bg-white rounded-lg mx-auto  shadow-smv hover:shadow-md cursor-pointer duration-500 transform">
                <svg
                  class="w-40 h-40 px-10 mx-auto"
                ...
                <div class="mx-auto text-center  text-gray-800  font-semibold text-2xl">
                  {" "}
                  Add an item
                </div>
              </div>
      ...
      {/* fic */}
      {/* <SummaryHeader /> */}
      <div class="flex justify-between items-baseline rounded-lg pt-8 pb-8">
        <span class="text-gray-800 text-4xl font-medium mr-6  "> Orders</span>
        <Link href={{ pathname: "/mcs/orders" }}>
          <a class="focus:outline-none border-none rounded-lg flex text-blue-500 font-medium tracking-wide ml-2">
            View all
          </a>
        </Link>
      </div>
      ...
      {/* <div class="bg-transparent pb-6">
        <nav class="flex flex-col text-2xl sm:flex-row border-b">
          <button class="text-gray-700 py-4 px-10 block hover:text-blue-500 focus:outline-none text-blue-500 border-b-4 font-medium border-blue-700">
            All Orders
          </button>
          <button class="text-gray-700 font-medium py-4 px-8 py-8 block hover:text-blue-500 focus:outline-none">
            In Progress Items (1)
          </button>
          <button class="text-gray-700 font-medium py-4 px-8 block hover:text-blue-500 focus:outline-none">
            Delivered Items (0)
          </button>
          <button class="text-gray-700 font-medium py-4 px-8 block hover:text-blue-500 focus:outline-none">
            Cancelled Items (0)
      ...
      <div
        class={`    relative rounded-t-lg   rounded-b-lg ${
          allOrders < 1 ? "bg-transparent shadow-none" : ""
        }`}
      >
        <div class=" flex-grow rounded-lg  ">
          {allOrders < 1 && (
            <div class="w-full h-auto text-center flex flex-col my-12 justify-center items-center bg-transparent ">
              <div class="h-32 w-32 mt-3">
                <svg
                  viewBox="0 0 20 20"
                  fill="currentColor"
                  class="clipboard-check w-full h-full border-2 rounded-full px-6 py-6   text-gray-600"
                >
              ...
              <div class="  text-5xl  pb-6  text-gray-500 ">
                Your orders will live here
              </div>

              <div class="text-gray-500 text-2xl leading-10 max-w-4xl">
                Once you start buying, you’ll be able to see your order list
                where you can see the items you will be receiving.
              </div>
            </div>
          )}
          {allOrders
              ...
              return (
                <div>
                  {order.items.map((item) => (
                    <div class="flex flex-col mt-6 bg-white rounded-t-lg shadow-sm rounded-b-lg">
                      <div class="flex gap-16 px-5 py-4 rounded-t-lg shadow-sm justify-between">
                        <div class="flex-col px-4 py-3 mt-4   ">
                          <div class=" text-2xl pb-3 text-gray-600  flex items-center gap-3">
                            <div class="w-4 h-4 bg-gray-500 pb-2 rounded-full"></div>
                            Ordered{" "}
                            {formatDistance(
                          ...
                          <div class="text-2xl text-gray-700 font-medium"></div>
                        </div>
                        <div class="flex-col px-6 py-3 mt-4  ">
                          <div class=" text-2xl pb-3 text-gray-600 font-semibold">
                            Total
                          </div>
                        ...
                        <div class="flex-col px-6 py-3 mt-4  ">
                          <div class=" text-2xl pb-4 text-gray-600 font-semibold">
                            Order ID
                          </div>
                          <Link
                            href={{
                        ...
                        <div class="flex items-center px-6 py-3 mt-4 ">
                          <Link
                            href={{
                              pathname: "/order",
                              query: { id: order.id },
                            ...
                            key={order.id}
                          >
                            <div class=" text-xl pb-3 text-blue-500 font-medium   cursor-pointer">
                              Details
                            </div>
                          </Link>
                        </div>
                      ...
                      <div class="flex w-full  justify-between rounded-b-lg dark:bg-gray-800 px-10 py-6 pb-12">
                        {/* <OrderProgressBar /> */}
                        <div class="w-2/3">
                          <div class="flex  mt-6">
                            <Link
                              href={{
                                pathname: "/item",
                                query: { id: item.productCode },
                              }}
                              key={item.id}
                            >
                              <img
                                class="border border-gray-400  h-48 w-48 shadow object-cover rounded-lg object-center -mr-2"
                                key={item.id}
                                src={item.image}
                                alt={item.title}
                              />
                            </Link>
                            <div class="flex flex-col justify-between font-normal px-10  py-3 w-full">
                              <div class="flex-col text-xl pb-3 text-gray-600">
                                <Link
                                  href={{
                                    pathname: "/item",
                                    query: { id: item.productCode },
                                ...
                                <div class="mt-3"></div>
                                by{" "}
                                <a class="text-2xl capitalize text-gray-600">
                                  {item.authorName}
                                </a>
                              </div>

                              <div class="flex-col mb-1">
                                <div class="pt-3 text-2xl text-gray-600">
                                  {formatMoney(item.price)}
                                </div>
                                <div>Cash on pickup</div>
                                {/* <div class=" text-2xl mt-2 text-gray-600">
                        ...
                        <div class="w-1/3 flex-col text-right">
                          <div class="w-full">
                            <button class="border-2 mt-5 rounded-lg text-green-600 font-medium border-green-600 w-full px-32 py-6">
                              Contact Seller
                            </button>
                          </div>
                          <div>
                            <button class=" mt-5 rounded-lg text-gray-600 font-medium  w-full px-32 py-6">
                              View Order Details
                            </button>
                          </div>
                        </div>
                ...
                //     <div
                //       class="flex w-full   border-b  items-center justify-between bg-white
                //         dark:bg-gray-800 px-6 py-12"
                //     >
                //       <div class="flex">
                //         <img
                //           class="border border-gray-500 rounded-lg h-64 w-64 shadow object-cover object-center -mr-2"
                //           key={order.id}
                //           src={order.image}
                //           alt={order.title}
                //         />
                ...
                //         <div class="flex flex-col font-bold px-8 pt-3">
                //           <span class="text-red-900 text-2xl">
                //             {order.title}
                //           </span>
                //           <span class="text-xl py-3 font-medium text-gray-600">
                //             ( {order.id} )
                //           </span>

                //           <span class="w-full bg-green-200 py-6 rounded font-medium text-green-600">
                //             <div></div>
                //             <svg
                //               viewBox="0 0 20 20"
                //               fill="currentColor"
                ...
                //               ></path>
                //             </svg>
                //             <span class="">Delivered on Aug 10, 2020</span>
                //             <br></br>
                //             <span class="text-lg pt-3 text-green-600">
                //               Tracking number: 234234913497
                //             </span>
                //           </span>
                //           <div class="flex mt-3">
                //             <span class=" rounded-full text-2xl   text-green-900">
                //               {order.quantity} left in stock
                //             </span>
                //           </div>
                //           <div class="mt-3 flex">
                //             <div class="flex">
                ...
                //         viewBox="0 0 20 20"
                //         fill="currentColor"
                //         class="dots-circle-horizontal w-12 h-12 text-gray-300"
                //       >
      ...
      <div class="mt-20">
        <span class="text-gray-800 text-4xl mr-6 font-medium  tracking-normal">
          Selling Promotions
        </span>
      </div>
