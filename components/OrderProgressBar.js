...
export default function OrderProgressBar() {
  return (
    <div class="w-full py-6 -ml-40">
      <div class="flex">
        <div class="w-1/4">
          <div class="relative mb-2">
            <div class="w-16 h-16 mx-auto bg-green-500 rounded-full text-lg text-white flex items-center">
        ...
        <div class="w-1/4">
          <div class="relative mb-2">
            ...
            <div class="w-16 h-16 mx-auto bg-white border-2 border-gray-200 rounded-full text-lg text-white flex items-center">
