        ...
        <div class="flex flex-col lg:flex-row mt-6">
          <div class="w-full lg:w-1/2 order-2">
            <div class="flex items-center">
              <button class="flex text-sm text-blue-500 focus:outline-none">
                <span class="flex items-center justify-center text-white bg-blue-500 rounded-full h-6 w-6 mr-2">
                  1
                </span>{" "}
                Contacts
              </button>
              <button class="flex text-sm text-gray-700 ml-8 focus:outline-none">
                <span class="flex items-center justify-center border-2 border-blue-500 rounded-full h-6 w-6 mr-2">
                  2
                </span>{" "}
                Shipping
              </button>
              <button
                ...
                disabled
              >
                <span class="flex items-center justify-center border-2 border-gray-500 rounded-full h-6 w-6 mr-2">
                  3
                </span>{" "}
                Payments
              </button>
            </div>
            <form class="mt-6 lg:w-3/4">
              <div>
                <h4 class="text-sm text-gray-500 font-medium">
                  Delivery method
                </h4>
                <div class="mt-6">
                  <button class="flex items-center justify-between w-full bg-white rounded-md border-2 border-blue-500 p-6 focus:outline-none">
                    <label class="flex items-center">
                      <input
                        type="radio"
                        class="form-radio h-6 w-6 text-blue-600"
                        checked
                      />
                  ...
                  <button class="mt-6 flex items-center justify-between w-full bg-white rounded-md border p-6 focus:outline-none">
                    <label class="flex items-center">
                      <input
                        type="radio"
                        class="form-radio h-6 w-6 text-blue-600"
              ...
              <div class="flex items-center justify-between mt-6">
                <button class="flex items-center text-gray-700 text-sm font-medium rounded hover:underline focus:outline-none">
                  ...
                  <span class="mx-3">Back step</span>
                </button>
          ...
          <div class="w-full mb-8 flex-shrink-0 order-1 lg:w-1/2 lg:mb-0 lg:order-2">
            <div class="flex justify-center lg:justify-end">
              <div class="border rounded-md max-w-md w-full px-3 py-3">
                  ...
                  <div class="flex">
                    ...
                    <div class="mx-3">
                      ...
                      <div class="flex items-center mt-2">
                        ...
                        <span class="text-gray-700 mx-3">2</span>
                        <button class="text-gray-500 focus:outline-none focus:text-gray-600">
                          <svg
                            class="h-6 w-6"
                            fill="none"
